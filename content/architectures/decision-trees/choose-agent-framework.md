...
Agent frameworks should be selected by state complexity, tool reliability needs, and whether workflows are graph-like, role-based, or conversational.
...
- Use graph-based orchestration for stateful multi-step systems
- Use lightweight tool calling for deterministic workflows
- Avoid heavyweight agents when a simple chain or job queue works
