...
description: "Decision tree for selecting short-term, long-term, and semantic memory"
tags:
  - agents
  - memory
  - embeddings
...
Memory architecture should start from user value, retention policy, and retrieval precision rather than from novelty.
...
- Use conversation windows for short-lived context
- Use summaries for session continuity
- Use vector or relational memory for long-term personalized behavior
