...
title: "Choose an Evaluation Framework"
entry_type: "guide"
section: "architectures"
description: "Decision tree for testing LLM, RAG, and agent applications"
tags:
  - evaluation
  - rag
  - agents
...
Evaluation should be introduced before production traffic and tied to regression tests, not only dashboards.
...
- Start with golden datasets and task-specific assertions
- Add model-graded evals only where human labels are too costly
- Track evals alongside traces and production feedback
