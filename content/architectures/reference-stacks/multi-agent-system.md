...
description: "Reference stack for stateful multi-agent applications"
tags:
  - agents
  - orchestration
  - planning
...
Multi-agent systems need explicit state, tool boundaries, observability, and fallback paths.
...
- Graph or workflow orchestration
- Shared memory and durable state
- Tool-call evaluation and trace inspection
