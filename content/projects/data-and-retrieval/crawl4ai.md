...
This project entry documents Crawl4AI's architecture and ecosystem position. For usage-oriented guidance (when to use this crawler, jobs it covers), see [Crawl4AI](../../tools/data-ingestion/crawl4ai-tool.md) in the tools vertical — that entry does not repeat this one's best_for/avoid_if verbatim, since the frames differ: this entry is about what Crawl4AI IS, the tool entry is about WHEN you'd reach for it.
