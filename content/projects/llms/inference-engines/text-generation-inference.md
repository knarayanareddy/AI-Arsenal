...
description: A production inference server for text generation models from Hugging Face
...
featured: false
status: archived
github_stars_last_30d: 10863
---

## Overview

Text Generation Inference is included as a notable llms project because it addresses a recurring AI engineering need with a visible open-source implementation and ecosystem adoption.
