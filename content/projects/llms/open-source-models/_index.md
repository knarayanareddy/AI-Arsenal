...
> Navigation file for the Open Source Models section. This file is auto-generated and is not a content entry.
...
- [Qwen](./qwen.md) — ⭐ 21281
- [Mistral Inference](./mistral-inference.md) — ⭐ 10816
...
- [Llama Models](./llama-models.md) — Meta open-weight model family widely used for local and production AI systems
- [Mistral Inference](./mistral-inference.md) — Reference inference code and assets for Mistral open-weight models
