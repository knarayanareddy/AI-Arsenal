...
title: "Review Data Retention For Prompts"
...
> **TL;DR:** Prompts may contain user data; set retention and redaction policies before launch.

Production LLM systems need operational controls before traffic, not after incidents.
...
- **Applies to:** monitoring, security, cloud
...
```python
if feature_flags.agent_actions_disabled:
    raise PermissionError("agent actions disabled")
```
