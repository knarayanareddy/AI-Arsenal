...
title: "Classify Failures Before Fixing Prompts"
...
> **TL;DR:** Label failures as retrieval, reasoning, tool, parsing, or policy failures before changing prompts.

Debugging improves when every failure is classified, reproducible, and linked to traces.
...
- **Applies to:** observability, tracing, evaluation
...
```python
trace.metadata["prompt_version"] = "support-rag-v12"
```
