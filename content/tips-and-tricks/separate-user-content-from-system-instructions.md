...
title: "Separate User Content From System Instructions"
...
> **TL;DR:** Use clear delimiters and message roles so user content cannot masquerade as policy.

LLM security starts by treating user input, retrieved context, and tool outputs as untrusted data.
...
- **Applies to:** security, guardrails, tool-use
...
```python
allowed_tools = {"researcher": ["search"], "writer": []}
```
