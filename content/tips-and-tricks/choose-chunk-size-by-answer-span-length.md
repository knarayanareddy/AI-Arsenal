...
title: "Choose Chunk Size by Answer Span Length"
category: "rag-tuning"
tags:
  - rag
  - retrieval
...
> **TL;DR:** Pick chunk sizes by the amount of text needed to answer real questions, not by arbitrary token defaults.
