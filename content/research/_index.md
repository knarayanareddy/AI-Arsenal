...
|---|---:|---|
| [papers](./papers/) | 25 entries | 2026-06-14 |

## Recently Added

- [Attention Is All You Need](./papers/attention-is-all-you-need.md)
- [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](./papers/bert.md)
...
- [Attention Is All You Need](./papers/attention-is-all-you-need.md) — Introduced the Transformer architecture that became the foundation for modern LLMs
- [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](./papers/bert.md) — Introduced bidirectional masked-language-model pretraining for language understanding
...
- [Language Models are Few-Shot Learners](./papers/language-models-are-few-shot-learners.md) — Showed that scaling language models enables broad few-shot and in-context learning behavior
- [The Llama 3 Herd of Models](./papers/llama-3-herd-of-models.md) — Documented Meta’s Llama 3 model family, training recipe, safety work, and evaluations
...
- [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks](./papers/retrieval-augmented-generation.md) — Introduced retrieval-augmented generation as a way to combine parametric models with external knowledge
