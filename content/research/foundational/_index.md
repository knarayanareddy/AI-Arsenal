...
- [Deep Residual Learning for Image Recognition](./he-2015-resnet.md)
...
- [Sequence to Sequence Learning with Neural Networks](./sutskever-2014-seq2seq.md) — Framed generation as mapping an input sequence to an output sequence with an encoder-decoder RNN, establishing the seq2seq paradigm that every generative LLM (as prompt-in, text-out) still instantiates
