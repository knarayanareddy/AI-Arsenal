...
Consumes the tool-span structure produced by [Trace Every Retrieval, Tool Call, and Agent Transition](../tracing/trace-every-agent-and-rag-step.md) and turns it into alertable per-tool reliability metrics, complementing the quality/cost focus of [Alert on Quality and Cost Regressions](../monitoring-alerting/alert-on-quality-and-cost-regressions.md). A firing tool-error alert is a primary entry point into the [Runbook for Agent and RAG Incidents](../incident-response/runbook-for-agent-and-rag-incidents.md). Operationalizes the tips [Cap Agent Tool Retries](../../tips-and-tricks/agents-and-orchestration/cap-agent-tool-retries.md), [Define Fallbacks for Tool Failures](../../tips-and-tricks/agents-and-orchestration/define-fallbacks-for-tool-failures.md), and [Detect Repeated Tool Calls](../../tips-and-tricks/agents-and-orchestration/detect-repeated-tool-calls.md).
