...
This routing page lists every tool in the Arsenal whose stack facet is Go. It is generated and maintained from each tool's frontmatter, so it stays exhaustive as the catalog grows.
...
1. **Scenario**: you need a stack fit of "Go" and want the full shortlist fast
