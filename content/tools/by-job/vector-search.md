...
entry_type: "guide"
section: "tools"
description: "Curated tools for vector search workflows in AI engineering"
tags:
  - llm
  - data
related_entries: []
...
This guide compares tools for the `vector-search` job. Use it as a routing page, then open the linked canonical project or tool entry for full details.
