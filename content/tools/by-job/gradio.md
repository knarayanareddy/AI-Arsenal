...
Gradio is a tool for prototyping workflows in AI engineering systems.
...
Link this tool from reference stacks, decision trees, and project entries using its canonical ID `gradio` rather than duplicating details.
