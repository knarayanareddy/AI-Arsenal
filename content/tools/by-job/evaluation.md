...
entry_type: "guide"
section: "tools"
description: "Curated shortlist for LLM, RAG, and agent evaluation"
tags:
  - evaluation
  - rag
  - agents
...
Evaluation tools should combine deterministic tests, human labels, model-graded checks, and trace-linked regression tracking.
...
- RAG evals: RAGAS and TruLens-style metrics
- App evals: DeepEval and promptfoo
- Integrated tracing: LangSmith, Langfuse, Phoenix
