...
entry_type: "guide"
section: "tools"
description: "Curated tools for web scraping workflows in AI engineering"
tags:
  - llm
  - data
related_entries: []
...
This guide compares tools for the `web-scraping` job. Use it as a routing page, then open the linked canonical project or tool entry for full details.
...
| [Tavily](../data-ingestion/tavily.md) | data ingestion | freemium | Yes | No | No | python | recommended |
