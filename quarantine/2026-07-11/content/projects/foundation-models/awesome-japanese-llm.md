...
name: Japanese LLM Landscape
artifact_type: library
category: llms
subcategory: models
description: Curated overview of Japanese-language LLMs, datasets, and related resources
...
docs_url: https://github.com/llm-jp/awesome-japanese-llm
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A regional model/data resource map candidate for Japanese-language AI engineering.
best_for:
  - You need the Japanese LLM Landscape problem space covered by an open-source component
...
Japanese LLM Landscape is curated overview of japanese-language llms, datasets, and related resources.

## Why it's in the Arsenal

Japanese LLM Landscape is a fresh candidate for the foundation-model layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/llm-jp/awesome-japanese-llm)
