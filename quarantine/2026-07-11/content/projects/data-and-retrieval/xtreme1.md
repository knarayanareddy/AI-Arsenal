...
category: multimodal
subcategory: tools
description: Multimodal data-labeling and annotation platform for images, 3D LiDAR, and LLM training data
...
docs_url: https://github.com/xtreme1-io/xtreme1
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A data-labeling and annotation layer for multimodal training and evaluation datasets.
best_for:
  - You need the Xtreme1 problem space covered by an open-source component
...
Xtreme1 is multimodal data-labeling and annotation platform for images, 3d lidar, and llm training data.

## Why it's in the Arsenal

Xtreme1 is a fresh candidate for the data-and-retrieval layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/xtreme1-io/xtreme1)
