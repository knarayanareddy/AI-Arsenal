...
supported_formats: []
api_compatible: null
org_or_maintainer: google-antigravity
...
description: Python SDK for building agents with Google Antigravity capabilities
...
docs_url: https://github.com/google-antigravity/antigravity-sdk-python
phase: framework
domain:
  - language
  - multimodal
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A Python agent-SDK candidate for the Google Antigravity ecosystem.
best_for:
  - You need the Antigravity SDK Python problem space covered by an open-source component
...
Antigravity SDK Python is python sdk for building agents with google antigravity capabilities.

## Why it's in the Arsenal

Antigravity SDK Python is a fresh candidate for the framework layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/google-antigravity/antigravity-sdk-python)
