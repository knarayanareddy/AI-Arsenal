...
description: Runnable notebooks comparing memory architectures, retrieval patterns, and production techniques for LLM agents
...
docs_url: https://github.com/NirDiamant/Agent_Memory_Techniques
phase: framework
domain:
  - language
  - multimodal
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A practical learning/reference project for comparing memory techniques with runnable implementations.
best_for:
  - You need the Agent Memory Techniques problem space covered by an open-source component
...
Agent Memory Techniques is runnable notebooks comparing memory architectures, retrieval patterns, and production techniques for llm agents.

## Why it's in the Arsenal

Agent Memory Techniques is a fresh candidate for the framework layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/NirDiamant/Agent_Memory_Techniques)
