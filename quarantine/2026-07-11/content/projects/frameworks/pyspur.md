...
description: Visual playground for iterating over agentic workflows with traces and human-in-the-loop steps
...
docs_url: https://github.com/PySpur-Dev/pyspur
phase: framework
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A visual workflow surface for constructing, inspecting, and iterating over agent pipelines.
best_for:
  - You need the PySpur problem space covered by an open-source component
...
PySpur is visual playground for iterating over agentic workflows with traces and human-in-the-loop steps.

## Why it's in the Arsenal

PySpur is a fresh candidate for the framework layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/PySpur-Dev/pyspur)
