...
description: Compact human-readable schema-aware data notation with LLM prompt benchmarks and SDKs
...
docs_url: https://github.com/toon-format/toon
phase: framework
domain:
  - language
  - general-purpose
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A data serialization candidate that trades JSON generality for compact, inspectable model-facing structures.
best_for:
  - You need the TOON problem space covered by an open-source component
...
TOON is compact human-readable schema-aware data notation with llm prompt benchmarks and sdks.

## Why it's in the Arsenal

TOON is a fresh candidate for the framework layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/toon-format/toon)
