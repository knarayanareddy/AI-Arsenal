...
supported_formats: []
api_compatible: null
org_or_maintainer: DenisSergeevitch
...
category: tooling
subcategory: tools
description: Provider-neutral agent skill and best-practice collection for coding-agent harness design
...
docs_url: https://github.com/DenisSergeevitch/agents-best-practices
phase: framework
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A provider-neutral practice library candidate for agent harness and workflow design.
best_for:
  - You need the Agents Best Practices problem space covered by an open-source component
...
Agents Best Practices is provider-neutral agent skill and best-practice collection for coding-agent harness design.

## Why it's in the Arsenal

Agents Best Practices is a fresh candidate for the framework layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/DenisSergeevitch/agents-best-practices)
