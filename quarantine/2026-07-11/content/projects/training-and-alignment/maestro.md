...
status: active
id: maestro
name: Roboflow Maestro
artifact_type: framework
category: multimodal
subcategory: fine-tuning
description: Fine-tuning workflow toolkit for multimodal models including PaliGemma, Florence, and Qwen-VL
...
docs_url: https://github.com/roboflow/maestro
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A focused training workflow candidate for fine-tuning vision-language models and evaluating the resulting model behavior.
best_for:
  - You need the Roboflow Maestro problem space covered by an open-source component
...
Roboflow Maestro is fine-tuning workflow toolkit for multimodal models including paligemma, florence, and qwen-vl.

## Why it's in the Arsenal

Roboflow Maestro is a fresh candidate for the training-and-alignment layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/roboflow/maestro)
