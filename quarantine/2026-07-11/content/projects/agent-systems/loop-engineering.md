...
supported_formats: []
api_compatible: null
org_or_maintainer: cobusgreyling
...
description: Patterns, starters, and CLI tools for designing reliable loops around AI coding agents
...
docs_url: https://github.com/cobusgreyling/loop-engineering
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A practice/tooling layer for coding-agent loops, cost control, audits, and iterative orchestration.
best_for:
  - You need the Loop Engineering problem space covered by an open-source component
...
Loop Engineering is patterns, starters, and cli tools for designing reliable loops around ai coding agents.

## Why it's in the Arsenal

Loop Engineering is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/cobusgreyling/loop-engineering)
