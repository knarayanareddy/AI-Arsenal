...
supported_formats: []
api_compatible: null
org_or_maintainer: Zackriya-Solutions
...
subcategory: tools
description: Privacy-first local AI meeting assistant with transcription, diarization, and local summarization
...
docs_url: https://github.com/Zackriya-Solutions/meetily
phase: agent-system
domain:
  - audio
  - language
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local meeting-intelligence application that keeps audio processing and summarization on user-controlled devices.
best_for:
  - You need the Meetily problem space covered by an open-source component
...
Meetily is privacy-first local ai meeting assistant with transcription, diarization, and local summarization.

## Why it's in the Arsenal

Meetily is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Zackriya-Solutions/meetily)
