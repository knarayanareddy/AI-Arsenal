...
category: tooling
subcategory: tools
description: Version-control workflow for AI coding agents with rewind, parity, and agent-aware change management
...
docs_url: https://github.com/regent-vcs/re_gent
phase: agent-system
domain:
  - language
  - general-purpose
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A version-control companion candidate for preserving, reviewing, and safely applying AI coding-agent changes.
best_for:
  - You need the re_gent problem space covered by an open-source component
...
re_gent is version-control workflow for ai coding agents with rewind, parity, and agent-aware change management.

## Why it's in the Arsenal

re_gent is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/regent-vcs/re_gent)
