...
description: Android GUI-agent framework for visual planning and operating mobile applications
...
docs_url: https://github.com/Core-Mate/OpenGUI
phase: agent-system
domain:
  - vision
  - multimodal
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A mobile computer-use candidate for visual perception, planning, and GUI actions.
best_for:
  - You need the OpenGUI problem space covered by an open-source component
...
OpenGUI is android gui-agent framework for visual planning and operating mobile applications.

## Why it's in the Arsenal

OpenGUI is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Core-Mate/OpenGUI)
