...
description: Power-user LLM frontend with extensions, character workflows, and local or hosted model integrations
...
docs_url: https://github.com/SillyTavern/SillyTavern
phase: agent-system
domain:
  - language
  - multimodal
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A feature-rich LLM frontend and extension surface for users who need control over model, prompt, and conversation workflows.
best_for:
  - You need the SillyTavern problem space covered by an open-source component
...
SillyTavern is power-user llm frontend with extensions, character workflows, and local or hosted model integrations.

## Why it's in the Arsenal

SillyTavern is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
