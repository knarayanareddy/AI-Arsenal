...
category: tooling
subcategory: tools
description: TypeScript terminal coding agent with stable prefixes, skills, hooks, and MCP-oriented workflows
...
docs_url: https://github.com/tigicion/dao-code
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A terminal agent candidate that treats prefix stability and cache reuse as first-class cost controls.
best_for:
  - You need the Dao Code problem space covered by an open-source component
...
Dao Code is typescript terminal coding agent with stable prefixes, skills, hooks, and mcp-oriented workflows.

## Why it's in the Arsenal

Dao Code is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/tigicion/dao-code)
