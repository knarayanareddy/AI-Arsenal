...
supported_formats: []
api_compatible: null
org_or_maintainer: Capsize-Games
...
description: Offline inference and creative AI workspace for art, voice conversations, chatbots, and workflows
...
docs_url: https://github.com/Capsize-Games/airunner
phase: agent-system
domain:
  - audio
  - vision
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local creative-AI workspace that combines inference, voice, art, chat, and automation surfaces.
best_for:
  - You need the AIRunner problem space covered by an open-source component
...
AIRunner is offline inference and creative ai workspace for art, voice conversations, chatbots, and workflows.

## Why it's in the Arsenal

AIRunner is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Capsize-Games/airunner)
