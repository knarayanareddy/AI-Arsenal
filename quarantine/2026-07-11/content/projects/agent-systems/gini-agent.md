...
supported_formats: []
api_compatible: null
org_or_maintainer: Open-Curiosity
...
description: Open-source agent that remembers and learns through persistent context and iterative workflows
...
docs_url: https://github.com/Open-Curiosity/gini-agent
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A memory-oriented agent framework candidate for persistent workflows and adaptive context.
best_for:
  - You need the Gini Agent problem space covered by an open-source component
...
Gini Agent is open-source agent that remembers and learns through persistent context and iterative workflows.

## Why it's in the Arsenal

Gini Agent is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Open-Curiosity/gini-agent)
