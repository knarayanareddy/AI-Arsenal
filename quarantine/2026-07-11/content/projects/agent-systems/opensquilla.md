...
description: Token-efficient agent framework focused on higher information density under a fixed budget
...
docs_url: https://github.com/opensquilla/opensquilla
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - An agent-efficiency candidate focused on preserving useful behavior under constrained context and token budgets.
best_for:
  - You need the OpenSquilla problem space covered by an open-source component
...
OpenSquilla is token-efficient agent framework focused on higher information density under a fixed budget.

## Why it's in the Arsenal

OpenSquilla is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/opensquilla/opensquilla)
