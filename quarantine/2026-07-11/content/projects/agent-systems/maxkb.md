...
description: Open-source enterprise agent platform combining knowledge bases, RAG, workflows, and model providers
...
docs_url: https://github.com/1Panel-dev/MaxKB
phase: agent-system
domain:
  - language
  - general-purpose
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A self-hosted agent/application platform for enterprise knowledge and workflow use cases.
best_for:
  - You need the MaxKB problem space covered by an open-source component
...
MaxKB is open-source enterprise agent platform combining knowledge bases, rag, workflows, and model providers.

## Why it's in the Arsenal

MaxKB is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
