...
description: Local coding agent that emphasizes model, machine, permission, and workflow control
...
docs_url: https://github.com/Gitlawb/zero
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local coding-agent candidate for teams that want control over model choice, machine access, and agent rules.
best_for:
  - You need the Zero problem space covered by an open-source component
...
Zero is local coding agent that emphasizes model, machine, permission, and workflow control.

## Why it's in the Arsenal

Zero is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Gitlawb/zero)
