...
category: tooling
subcategory: tools
description: Authorized OSINT agent with interactive REPL, MCP server, and CLI research tools
...
docs_url: https://github.com/OpenOSINT/OpenOSINT
phase: agent-system
domain:
  - language
  - reasoning
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - An OSINT research agent candidate with explicit authorized-use and security-research boundaries.
best_for:
  - You need the OpenOSINT problem space covered by an open-source component
...
OpenOSINT is authorized osint agent with interactive repl, mcp server, and cli research tools.

## Why it's in the Arsenal

OpenOSINT is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/OpenOSINT/OpenOSINT)
