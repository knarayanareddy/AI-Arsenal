...
description: Open-source computer-use agent framework for desktop and GUI automation
...
docs_url: https://github.com/iFurySt/open-codex-computer-use
phase: agent-system
domain:
  - vision
  - multimodal
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local computer-use candidate focused on visual desktop interaction and agent-controlled GUI operations.
best_for:
  - You need the Open Codex Computer Use problem space covered by an open-source component
...
Open Codex Computer Use is open-source computer-use agent framework for desktop and gui automation.

## Why it's in the Arsenal

Open Codex Computer Use is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/iFurySt/open-codex-computer-use)
