...
category: tooling
subcategory: tools
description: Local coding-agent bridge using ChatGPT Developer Mode through MCP and tunnel integrations
...
docs_url: https://github.com/rebel0789/codexpro
phase: agent-system
domain:
  - language
  - general-purpose
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local integration candidate for connecting a coding workflow to ChatGPT Developer Mode through MCP.
best_for:
  - You need the CodexPro problem space covered by an open-source component
...
CodexPro is local coding-agent bridge using chatgpt developer mode through mcp and tunnel integrations.

## Why it's in the Arsenal

CodexPro is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/rebel0789/codexpro)
