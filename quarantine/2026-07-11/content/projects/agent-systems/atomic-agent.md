...
supported_formats: []
api_compatible: null
org_or_maintainer: AtomicBot-ai
...
description: Local-first agent framework optimized for private models, long context, and tool calling
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A local-first agent framework candidate for private model operation and explicit tools.
best_for:
  - You need the Atomic Agent problem space covered by an open-source component
...
Atomic Agent is local-first agent framework optimized for private models, long context, and tool calling.

## Why it's in the Arsenal

Atomic Agent is a fresh candidate for the agent-system layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/AtomicBot-ai/atomic-agent)
