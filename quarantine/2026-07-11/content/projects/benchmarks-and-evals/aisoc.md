...
description: Self-hosted AI security operations platform for alert fusion, triage, and MITRE ATT&CK investigation
...
docs_url: https://github.com/beenuar/AiSOC
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - An agent-assisted security-operations platform candidate combining alert data, investigation, and purple-team workflows.
best_for:
  - You need the AiSOC problem space covered by an open-source component
...
AiSOC is self-hosted ai security operations platform for alert fusion, triage, and mitre att&ck investigation.

## Why it's in the Arsenal

AiSOC is a fresh candidate for the benchmark-and-eval layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/beenuar/AiSOC)
