...
category: evaluation
subcategory: tools
description: Agent-driven platform for source-code CVE discovery, verification, and report generation
...
docs_url: https://github.com/larlarua/AutoCVE
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - An automated vulnerability-analysis workflow candidate that must be operated only on authorized code.
best_for:
  - You need the AutoCVE problem space covered by an open-source component
...
AutoCVE is agent-driven platform for source-code cve discovery, verification, and report generation.

## Why it's in the Arsenal

AutoCVE is a fresh candidate for the benchmark-and-eval layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/larlarua/AutoCVE)
