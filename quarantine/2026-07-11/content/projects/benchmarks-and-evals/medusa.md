...
supported_formats: []
api_compatible: null
org_or_maintainer: Pantheon-Security
...
category: evaluation
subcategory: tools
description: AI-first security scanner covering repositories, secrets, agent skills, and AI-specific attack signatures
...
docs_url: https://github.com/Pantheon-Security/medusa
...
health_signals:
  ...
  - community-driven
ecosystem_role:
  - A security scanning candidate for AI repositories, agent configuration, secrets, and model-connected attack surfaces.
best_for:
  - You need the Medusa problem space covered by an open-source component
...
Medusa is ai-first security scanner covering repositories, secrets, agent skills, and ai-specific attack signatures.

## Why it's in the Arsenal

Medusa is a fresh candidate for the benchmark-and-eval layer because it addresses a concrete engineering decision and has an inspectable open-source implementation.
...
- [Official source](https://github.com/Pantheon-Security/medusa)
