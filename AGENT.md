...
Folders (lifecycle phase): foundation-models, frameworks, inference-engines, agent-systems, data-and-retrieval, training-and-alignment, benchmarks-and-evals
...
Schema-first catalog with projects, tools, research, tips, guides, architectures, observability, community, benchmarks, trends, and generated data. For live counts read `/data/stats.json` (regenerated by automation); this file is hand-maintained and deliberately carries no counts.
